...
QLIC 1.0.0 is the first stable file-format and C API release. It is unsigned:
it passed the automated release gates, but the Windows binaries and PowerShell
scripts do not have an Authenticode publisher identity.
